...
Because of the warning i do not use `ZoneContextManager` as `commented on code` [here](https://github.com/niko-achilles/otlp-logzio-fullstack/blob/main/frontend/lib/useOpentemetry.js#L11)
